...
# Check if any of the indexes are set to 0, and if so, predict "Bad"
if any(value == 0 for value in adjusted_scores.values()):
    prediction = [0]  # Crop health status is Bad
else:
